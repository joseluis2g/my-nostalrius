...
static constexpr auto STATUS_SERVER_NAME = "MyNostalrius";
static constexpr auto STATUS_SERVER_VERSION = "0.3";
static constexpr auto STATUS_SERVER_DEVELOPERS = "Alejandro Mujica & Mark Samman";
